...
type CategoryList struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Categories    []*Category            `protobuf:"bytes,1,rep,name=categories,proto3" json:"categories,omitempty"` // repeated is a list
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_course_category_proto_rawDesc = "" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id2\xe3\x02\n" +
	"\x0fCategoryService\x12C\n" +
	"\x0eCreateCategory\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse\"\x00\x12G\n" +
	"\x14CreateCategoryStream\x12\x19.pb.CreateCategoryRequest\x1a\x10.pb.CategoryList\"\x00(\x01\x12Z\n" +
	"!CreateCategoryStreamBidirectional\x12\x19.pb.CreateCategoryRequest\x1a\x14.pb.CategoryResponse\"\x00(\x010\x01\x12/\n" +
...
var file_proto_course_category_proto_depIdxs = []int32{
	...
	3, // 7: pb.CategoryService.CreateCategory:output_type -> pb.CategoryResponse
	4, // 8: pb.CategoryService.CreateCategoryStream:output_type -> pb.CategoryList
	3, // 9: pb.CategoryService.CreateCategoryStreamBidirectional:output_type -> pb.CategoryResponse
